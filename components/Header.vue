...
<template>
    <nav
        class="bg-neutral sticky z-30 top-5 mt-5 shadow-[0_5px_20px_0_rgba(0,0,0,0.10)] rounded-full w-screen max-w-7xl flex relative justify-between items-center mx-auto p-2">
        <div class="inline-flex pl-5">
            <a href="/">
                <div class="hidden md:block">
                    <img src="@/assets/images/logo/text-dark.png" alt="logo" class="h-7" />
                </div>
                <div class="block md:hidden">
                    <img src="@/assets/images/logo/square-light.png" alt="logo" class="h-10" />
                </div>
            </a>
        </div>
                    ...
                    <button
                        ...
                        <div class="flex items-center justify-center relative h-8 w-8 rounded-full">
                            <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                                ...
                                style=" display: block; fill: none; height: 15px; width: 15px; stroke: currentcolor; stroke-width: 5.33333; overflow: visible; ">
                                <g fill="none">
                                    <path
        ...
        <div class="flex-initial">
            <div class="flex justify-end items-center relative">
                <div class="flex mr-4 items-center">
                    <a class="inline-block py-2 px-3 hover:bg-gray-200 rounded-full" target="_blank"
                        href="https://github.com/sponsors/KaanaOfficial">
                        <div class="flex items-center relative cursor-pointer whitespace-nowrap">{{
                            $t('header.buttons.becomeSponsor') }}</div>
                    </a>
                    <div class="block relative">
                        ...
                        <button type="button" class="inline-block py-2 px-3 rounded-full relative">
                            <div class="flex items-center h-5">
                                <UIToggleDarkmode />
                            </div>
                        </button>
                ...
                <div class="block">
                    <div class="inline relative">
                        <button type="button"
                            class="rounded-full hover:shadow-lg p-[3px] bg-gradient-to-r from-blue-600 via-green-500 to-yellow-400 to-red-700 shadow-md">
                            <div
                                class="inline-flex items-center relative px-2 bg-neutral rounded-full text-center font-bold text-19 leading-1.111 tracking-wider">
                                <div class="pl-1">
                                    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                                        role="presentation" focusable="false"
